...
;public class delroom extends JFrame implements ActionListener 
{	
	//JFrame fr;
	JPanel p,p1; 
	JLabel l;
	...
	public delroom()
	{
	   ...
	   //  t.setAutoResizeMode(JTable.AUTO_RESIZE_ALL_COLUMNS);
		...
		m=new JButton("OK");
		l=new JLabel();
		l.setText("<html>Please enter the Client's Id for record deletion:<br></html>");
		
		txt=new JTextField(7);
		l.setFont(new Font("Times New Roman", Font.PLAIN, 23));
		txt.setFont(new Font("Times New Roman", Font.PLAIN, 23));
		...
		p1.add(b);
		add(p);
		//l.setBounds(384, 830, 250, 40);
		//txt.setBounds(584, 830, 50, 45);
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		else if(evt.getActionCommand()=="OK")
		{
			  int id=Integer.parseInt(txt.getText());
		       ...
		       try{
		           ...
		           q="Delete from customers where idcustomers=?";
